...
AVLTree<Integer> balanced = new AVLTree<>();
Integer nums[] = { 63, 22,78, 16, 28, 65, 85, 7, 21, 25, 51, 64, 72,
82, 92, 3, 13, 27, 31, 55, 69, 79, 83, 86, 33 };
for (Integer n : nums) {
balanced.add(n);
}
System.out.println("Testing tree: " + balanced);
List<Integer> ansList = Arrays.asList(new Integer[] { 63, 22, 16, 7, 3,
13, 21, 25, 27, 31, 33, 55, 64, 69, 72, 79, 83, 86, 92, 85, 78 });
Set<Integer> ans = new HashSet<>();
for (Integer num : ansList) {
ans.add(num);
}
...
System.out.println("Testing tree: " + balanced);
List<Integer> ansList = Arrays.asList(new Integer[] { 36, 19, 8, 22,
23, 58, 75, 94, 73});
Set<Integer> ans = new HashSet<>();
for (Integer num : ansList) {
ans.add(num);
...
System.out.println("Testing tree: " + balanced);
List<Integer> ansList = Arrays.asList(new Integer[] { 65, 26, 15, 21,
27, 63, 68, 80, 92, 84, 83 });
Set<Integer> ans = new HashSet<>();
for (Integer num : ansList) {
ans.add(num);
}
...
System.out.println("Testing tree: " + balanced);
List<Integer> ansList = Arrays.asList(new Integer[] { 77, 26, 32, 80,
78 });
Set<Integer> ans = new HashSet<>();
for (Integer num : ansList) {
ans.add(num);
...
System.out.println("Testing tree: " + balanced);
List<Integer> ansList = Arrays.asList(new Integer[] { 50, 25, 15, 20,
35, 70, 80, 85, 75 });
Set<Integer> ans = new HashSet<>();
for (Integer num : ansList) {
ans.add(num);
...
System.out.println("Testing tree: " + balanced);
List<Integer> ansList = Arrays.asList(new Integer[] { 15, 6, 4, 5, 7,
23, 71, 50 });
Set<Integer> ans = new HashSet<>();
for (Integer num : ansList) {
ans.add(num);
...
AVLTree<Integer> balanced = new AVLTree<>();
Integer nums[] = { 50, 25, 75, 20, 35, 70, 85, 15, 23, 30, 37, 65, 73,
80, 90 };
for (Integer n : nums) {
balanced.add(n);
}
System.out.println("Testing tree: " + balanced);
List<Integer> ansList = Arrays.asList(new Integer[] { 50, 25, 20, 15,
23, 30, 37, 65, 73, 80, 90, 85, 75 });
Set<Integer> ans = new HashSet<>();
for (Integer num : ansList) {
ans.add(num);
}
